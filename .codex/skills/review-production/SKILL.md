...
- CRUD 脚手架是否通过 `tools/codegen/java-springboot-crud/scripts/crud-spring-bootv2` 或 `crud-spring-bootv34` 生成，而不是手工拼文件。
- CRUD 生成脚本是否与项目 Spring Boot 版本匹配。
- CRUD 生成输出是否明确包含 Spring Boot 版本、版本判断依据和实际使用脚本。
